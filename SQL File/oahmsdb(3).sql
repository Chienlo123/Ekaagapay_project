...
CREATE TABLE `tblarchive` (
  ...
  `CommunicationAddress` mediumtext CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `EmergencyAddress` mediumtext CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `EmergencyContactnumber` bigint(11) DEFAULT NULL,
  `AddedBy` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `RegitrationDate` timestamp NULL DEFAULT current_timestamp(),
  `gender` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `pension` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `status` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `EmergencyPerson` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
(25, 'Rhine Bareja female 1969-10-19', '11:58:PM', '2023-01-29', '0'),
(26, 'Chienlo Mejia', '11:58:PM', '2023-01-29', '0');
