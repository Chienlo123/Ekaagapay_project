...
<head>
  ...
  <title>E-Kaagapay|| Search Senior Citizen Details</title>
  <!-- base:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">Search Senior Citizen Details By Registration Number</h4>
          </li>
          <li class="nav-item">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                                            ...
                                            <a href="manage-scdetails.php?id=
                                            <?php echo $row['ID']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm btn-icon-text">Delete <i class="typcn typcn-delete-outline btn-icon-append"></i></a>
                          </div>
                        </td>
                      </tr> <?php 
$cnt=$cnt+1;
