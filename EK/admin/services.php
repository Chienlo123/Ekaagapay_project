...
<head>
  ...
  <title>E-Kaagapay || Manage Services</title>
  <!-- base:css -->
              ...
              <div class="card">
                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">Manage Services</h4>
                  <p class="card-description" style="padding-left: 20px;"> 
                    Manage services in E-Kaagapay <a href="add-services.php?id=<?php echo $row['ID']?>" class="btn btn-primary btn-sm btn-icon-text mr-3" style="margin-left: 90%;">Add <i class="typcn typcn-edit btn-icon-append"></i> </a> 
                  </p>
